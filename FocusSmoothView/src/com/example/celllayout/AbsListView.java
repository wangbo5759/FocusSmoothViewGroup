...
//    LongSparseArray<Integer> mCheckedIdStates;
    ...
    protected boolean mSmoothScrollWhenTrackBall = true;
    /**
    ...
    private void initAbsListView() {
        ...
        mGroupFlags = ReflectUtil.getIntField(this, ViewGroup.class, "mGroupFlags");
...
//        LongSparseArray<Integer> checkIdState;
    ...
    View obtainView(int position) {
    	boolean[] isScrap = new boolean[1];
    	return obtainView(position, isScrap);
    }
...
//                ReflectUtil.invokeMethodForBoolean(View.class, "dispatchFinishTemporaryDetach", child);
            }
        } else {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (clipToPadding) {
            ...
            ReflectUtil.setIntField(ViewGroup.class, "ViewGroup", (ReflectUtil.getIntField(this, ViewGroup.class, "mGroupFlags") & ~CLIP_TO_PADDING_MASK));
        }
        ...
        if (clipToPadding) {
            ...
            ReflectUtil.setIntField(ViewGroup.class, "ViewGroup", 
            		(ReflectUtil.getIntField(this, ViewGroup.class, "mGroupFlags") | CLIP_TO_PADDING_MASK));
        }
    }
    ...
    private void drawSelector(Canvas canvas) {
    	//not to draw selector of the whole list row
            ...
            switch (event.getAction()) {
                case MotionEvent.ACTION_SCROLL: {
                    if (mTouchMode == TOUCH_MODE_REST) {
                        ...
                        if (vscroll != 0) {
                            final int delta = (int) (vscroll * ReflectUtil.invokeMethodForFloat(View.class, "getVerticalScrollFactor", this));
